    ...
    <footer className="border-t border-zinc-800 py-6 mt-auto">
      <div className="max-w-2xl mx-auto px-4 flex flex-col items-center gap-3 text-xs text-zinc-600">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md border border-zinc-700 hover:border-zinc-500 bg-zinc-900/50 hover:bg-zinc-800/50 text-zinc-400 hover:text-zinc-300 transition-colors"
        >
